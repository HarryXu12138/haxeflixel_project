...
class GameEndState extends FlxState {
    ...
    private function initreturnToMainMenuButton():Void {
        returnToMainMenuButton = new FlxButton(FlxG.width * 0.7, FlxG.height * 0.05, "Restart", restartGame);
    ...
    private function initBackground():Void {
        ...
        if (!win) background.loadGraphic("assets/images/GameOver.png");
        else  background.loadGraphic("assets/images/Victory.png");
        add(background);
    }
}